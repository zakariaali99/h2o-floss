...
const STORAGE_KEY = 'h2o.floatingCTA.orderDismissed'
...
export function FloatingOrderCTA() {
  ...
  return (
    ...
    >
      {/* Floating WhatsApp Fast-Order Button (Above Order Button) */}
      <button
        type="button"
      ...
      >
        ...
        <span className="absolute -top-0.5 -start-0.5 flex size-3">
          <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-300 opacity-75" />
          <span className="relative inline-flex size-3 rounded-full border-2 border-white bg-emerald-400 dark:border-slate-900" />
        </span>

        {/* WhatsApp Icon */}
        <svg
          className="size-5 shrink-0 fill-current transition-transform duration-300 group-hover:scale-110"
          viewBox="0 0 24 24"
